class Enemigos {
  ...
  animarCompetidor(objeto, spline, mesh) {
    ...
    var origen2 = {p: 0.02}; // Desde el principio hasta la mitad del recorrido (4 segs)
    var destino2 = {p: 0.45};
    ...
    var origen3 = {p: 0.45}; // Desde la mitad del recorrido hasta el final (6 segs)
    var destino3 = {p: 1.0};

    var animacion3 = new TWEEN.Tween(origen3)
      .to(destino3, 13000 * this.setNumeros[getRandom()]) // ( 6 segundos)
      .easing(TWEEN.Easing.Linear.None)
      .onUpdate(function() {
    ...
    var origen5 = {p: 0.02}; // Desde el principio hasta la mitad del recorrido (4 segs)
    var destino5 = {p: 0.45};
    ...
    var origen6 = {p: 0.45}; // Desde la mitad del recorrido hasta el final (6 segs)
    var destino6 = {p: 1.0};

    var animacion6 = new TWEEN.Tween(origen6)
      .to(destino6, 13000 * this.setNumeros[getRandom()]) // ( 6 segundos)
      .easing(TWEEN.Easing.Linear.None)
      .onUpdate(function() {
